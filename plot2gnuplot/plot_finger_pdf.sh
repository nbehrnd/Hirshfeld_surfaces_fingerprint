...
# the one provided by CrystalExplorer.
#
# On the CLI, your instructions follow the pattern of:
#
# chmod u+x plot_finger_pdf.sh      # provision of the executable bit
# ./plot_finger_pdf.sh example.dat  # generation of the .pdf plot
#
