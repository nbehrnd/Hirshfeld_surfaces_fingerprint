...
# name:    plot_finger_png_sparse.sh
...
# provided by CrystalExplorer.  In line with the concept of 'conditional
# printing' in the .pdf generating sparse scripts, only 'non-zero pixels'
# are put on the explicitly transparent canvas.
#
# On the CLI, your instructions follow the pattern of:
#
# chmod u+x plot_finger_png_sparse.sh      # provision of the executable bit
# ./plot_finger_png_sparse.sh example.dat  # generation of the .png plot
#
