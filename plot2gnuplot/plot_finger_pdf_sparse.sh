...
# name:    plot_finger_pdf_sparse.sh
...
# the plot provided as .pdf vector file.  The color scheme here matches
# the one provided by CrystalExplorer.  By virtue of conditional printing,
# only pixels with a z-value greater than zero will be considered for the
# scatter plot.  Without loosing information from the .dat file read, this
# translates into the generation of a much smaller .pdf file.  Thanks to
# Ethan Merrit suggesting this improvement.
#
# On the CLI, your instructions follow the pattern of:
#
# chmod u+x plot_finger_pdf_sparse.sh      # provision of the executable bit
# ./plot_finger_pdf_sparse.sh example.dat  # generation of the .pdf plot
#
